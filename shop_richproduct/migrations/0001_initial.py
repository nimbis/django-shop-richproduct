...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RichProduct'
        db.create_table(u'shop_richproduct_richproduct', (
        ...
        db.send_create_signal(u'shop_richproduct', ['RichProduct'])


    def backwards(self, orm):
        # Deleting model 'RichProduct'
        db.delete_table(u'shop_richproduct_richproduct')
    ...
    models = {
        ...
        u'shop_richproduct.richproduct': {
            'Meta': {'object_name': 'RichProduct', '_ormbases': ['shop.Product']},
    ...
    complete_apps = ['shop_richproduct']